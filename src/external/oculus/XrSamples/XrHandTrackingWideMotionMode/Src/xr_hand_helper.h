...
class XrHandHelper : public XrHelper {
   public:
    enum HandType { HANDTYPE_BASE, HANDTYPE_WMM };

    XrHandHelper(XrInstance instance, bool isLeft, HandType handType)
        : XrHelper(instance), isLeft_(isLeft), handType_(handType) {
