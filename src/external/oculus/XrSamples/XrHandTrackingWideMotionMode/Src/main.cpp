...
class XrHandTrackingWideMotionModeApp : public OVRFW::XrApp {
   public:
    ...
    virtual bool AppInit(const xrJava* context) override {
        ...
        /// Build UI
        bigText_ = ui_.AddLabel("Open XR Wide Motion Mode", {0.1f, -0.25f, -2.0f}, {1300.0f, 100.0f});

        renderLabelBaseHandsButton_ = ui_.AddLabel("X", {0.25f, 0.75f, -2.0f}, {100.0f, 100.0f});
        renderLabelBaseHandsButton_->SetSurfaceColor(0, {1.0f, 0.0f, 0.0f, 1.0f});

        renderBaseHandsButton_ =
            ui_.AddButton("Stop Rendering Base Hands", {-0.5f, 0.75f, -2.0f}, {500.0f, 100.0f}, [=]() {
        ...
        renderLabelWideMotionModeHandsButton_ = ui_.AddLabel("X", {0.25f, 0.5f, -2.0f}, {100.0f, 100.0f});
        ...
        renderWideMotionModeHandsButton_ = ui_.AddButton(
            "Stop Rendering Wide Motion Mode Hands", {-0.5f, 0.5f, -2.0f}, {500.0f, 100.0f}, [=]() {
